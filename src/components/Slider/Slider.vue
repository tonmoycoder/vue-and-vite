<template>
  ...
  <div class="section">
    <div
      class="hero-slider swiper-container slider-nav-style-1 slider-dot-style-1"
    >
      <!-- Hero slider Active -->
            ...
            <div class="row">
              ...
              >
                <div class="hero-slide-content slider-animated-1">
                  ...
                  <a href="#" class="btn btn-lg btn-primary btn-hover-dark mt-5"
                    >Shop Now</a
                  >
                </div>
              </div>
              <div class="col-xl-6 col-lg-5 col-md-5 col-sm-5">
                <div class="hero-slide-image">
                  <img
                    src="../../assets/images/slider-image/slider-1.png"
                    alt=""
                  />
                </div>
              </div>
          ...
          <div class="container align-self-center">
            <div class="row">
              ...
              <div class="col-xl-6 col-lg-5 col-md-5 col-sm-5">
                <div class="hero-slide-image">
                  <img
                    src="../../assets/images/slider-image/slider-2.png"
                    alt=""
                  />
                </div>
              </div>
